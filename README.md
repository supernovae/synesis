...
| **Resource limits** | CPU: 1 core, Memory: 512Mi, Ephemeral storage: 100Mi |
...
| `SANDBOX_CPU_LIMIT` | `1` | CPU limit per sandbox pod |
| `SANDBOX_MEMORY_LIMIT` | `512Mi` | Memory limit per sandbox pod |
