...
| **CPU-Inference** | m6i.2xlarge (8 vCPU, 32 GiB) | 1 | Mistral Nemo 12B FP8 router model (CPU-only vLLM) |
...
| **EFS Storage** | ~$0.30/GB | **~$30-60** | Shared model volume, pay for actual usage |
