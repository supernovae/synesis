...
|---------|----------|-------------------|
| **Small** | 3x L40S (3x g6e.2xlarge) | GPU 0: Router + Critic (Qwen2.5-14B-Instruct FP8); GPU 1: General (Qwen3.5-35B-A3B FP8); GPU 2: Coder (FP8) |
