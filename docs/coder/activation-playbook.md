...
| `OTEL_EXPORTER_OTLP_ENDPOINT` | `<your collector OTLP HTTP URL>` (e.g. `http://otel-collector:4318/v1/traces` — Synesis uses **OTLP/HTTP protobuf** via OpenTelemetry JS SDK 2.x; see [`docs/development/TESTING.md`](../development/TESTING.md)) |
