...
- Diagnostic logging: `sse_first_executor_chunk_diag`, `sse_first_content_token`, `sse_first_content_delta`

```python
# Node -> user-friendly message
NODE_STATUS_MESSAGES = {
    "entry_classifier": "Analyzing request…",
    "strategic_advisor": "Advising…",
    "frame_extractor": "Extracting frame…",
    "router": "Planning…",
    "planner": "Building execution plan…",
    "executor": "Generating code…",  # text mode → "Generating response…"
    "writer": "Writing…",
    "patch_integrity_gate": "Validating code…",
    "critic": "Reviewing…",
    "final_scrubber": "Finalizing…",
    "respond": "Finishing…",
}
```
