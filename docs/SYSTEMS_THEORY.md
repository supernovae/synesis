...
See [INTENT_ANCHORS.md](INTENT_ANCHORS.md) for the redirect and pointers to [WORKFLOW.md](WORKFLOW.md).
...
| [WORKFLOW.md](WORKFLOW.md) | Full pipeline flow, router-governed evidence, anti-oscillation |
