...
This document records **design decisions** for how Synesis composes LLM prompts across nodes: what is universal, what is taxonomy-steered, how regulated domains are handled, and how the critic relates to taxonomy. It complements [WORKFLOW.md](WORKFLOW.md) (graph flow) and [performance.md](performance.md) (prefix caching).
...
- [WORKFLOW.md](WORKFLOW.md) — graph nodes and routing; links here for prompt layering.
