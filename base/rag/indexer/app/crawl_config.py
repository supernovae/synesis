...
DEFAULT_MAX_LINKS_PER_PAGE = int(os.getenv("SYNESIS_INDEXER_WEB_MAX_LINKS_PER_PAGE", "80"))
...
def effective_crawl_config(config: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "max_links_per_page": max(1, int(cfg.get("max_links_per_page", DEFAULT_MAX_LINKS_PER_PAGE))),
    }
