...
function criticCompletionsUrl(config) {
...
export function createCritiqueTool(config) {
    return {
        name: "synesis_critique",
        description: "Submit code for critic review. Returns approval-oriented feedback, blocking issues, and improvement suggestions.",
        inputSchema: {
            type: "object",
            properties: {
        ...
        handler: async (args) => {
            try {
                ...
                const systemPrompt = "You are a code critic. Review the following code for correctness, " +
