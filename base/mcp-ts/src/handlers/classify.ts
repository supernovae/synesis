...
export function createClassifyTool(config: McpConfig): McpToolDefinition {
  return {
    name: "synesis_classify",
    description:
      "Classify a task description. Returns intent_class, is_code_task, difficulty, task_size, and taxonomy metadata from the planner entry classifier.",
    inputSchema: {
      type: "object",
      properties: {
