...
export const rustPack = {
    ...
    fixRecipes: [
        ...
        },
        {
            ...
            template: "In {file}: verify the method name, import the trait that provides it, or use fully-qualified syntax if ambiguous.",
        ...
        },
        {
            ...
            template: "In {file}: add explicit lifetime annotations, consider owned types, or use 'static for global data where appropriate.",
