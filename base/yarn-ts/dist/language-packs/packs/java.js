...
export const javaPack = {
    ...
    fixRecipes: [
        ...
        },
        {
            ...
            template: "In {file}: match the superclass method signature exactly (including return type covariance) and add @Override.",
        ...
        },
        {
            ...
            template: "In {file}: initialize at declaration, ensure every path assigns before use, or use Optional for absent values.",
