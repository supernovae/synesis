...
describe("injectCacheMarkers", () => {
  ...
  it("only converts marked messages to array content, leaves unmarked as-is", () => {
    const msgs = [
      { role: "system", content: "sys" },
      { role: "user", content: "q1" },
      { role: "assistant", content: "a1" },
