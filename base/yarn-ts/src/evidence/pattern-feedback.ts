...
export function initPatternFeedback(config: AppConfig): void {
...
export function reportPatternUsage(patternId: string, outcome: "pass" | "fail"): void {
  if (!_enabled || !_adminUrl) return;
