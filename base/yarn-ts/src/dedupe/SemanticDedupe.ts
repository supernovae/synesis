 ...
 */
export function normalizeSearchQueryForSafety(raw: string, maxChars: number): string {
...
export interface SegmentDedupeResult {
 ...
 */
export function applySegmentReadSearchDedupe(
  calls: ParsedToolCall[],
