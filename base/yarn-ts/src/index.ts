...
import { buildClaudeMessagesRouteDependencies } from "./server/route-dependencies.js";
...
// --- Claude Messages API ---
const claudeMessagesRouteDependencies = buildClaudeMessagesRouteDependencies({
  app,
  config,
  crypto,
  getTracer,
