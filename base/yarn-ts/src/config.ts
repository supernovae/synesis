...
const EnvSchema = z.object({
  ...
  // Helm may store SQLAlchemy async URLs in synesis-admin-db-url; node-pg rejects +asyncpg.
  ...
  SYNESIS_YARN_CACHE_PRESERVING_SYSTEM_CONTEXT_ENABLED: z
    .string()
    .optional()
    .transform((v) => (v ?? "true").toLowerCase() !== "false"),
  ...
  SYNESIS_YARN_MCP_TOOL_MAX_CONCURRENT_PER_CALLER: z.coerce.number().default(4),
  SYNESIS_YARN_MCP_TOOL_MAX_CONCURRENT_GLOBAL: z.coerce.number().default(100),
