...
import { useSupportAssistantChat } from "../../api/hooks";
...
export default function SupportAssistant() {
  ...
  const chatMutation = useSupportAssistantChat();
    ...
    <div className="flex h-[calc(100vh-8rem)] flex-col space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Ask account and usage questions in user context. This assistant is intentionally restricted
          from admin-only interfaces and trace inspection.
        </p>
      </div>
        ...
        {messages.length === 0 && (
          <div className="flex h-full items-center justify-center text-sm text-gray-400">
            <div className="text-center">
              ...
              <p>Ask me about your usage, account context, or product behavior.</p>
              <p className="mt-1 text-xs">
                You can paste relevant context below.
              </p>
            </div>
          </div>
        )}
