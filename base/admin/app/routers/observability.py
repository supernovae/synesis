...
@router.get("/cache/canary-report")
async def cache_canary_report(_user: UserInfo = Depends(require_org_admin)):
    """Latest provider cache canary report generated by CI or an operator cron."""
    return load_cache_canary_report()
