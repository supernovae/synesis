...
async def create_offering(
    ...
    *,
    ...
    et = validate_effort_tier(effort_tier)
...
async def update_offering(
    ...
    if "effort_tier" in patch and patch["effort_tier"] is not None:
        row.effort_tier = validate_effort_tier(str(patch["effort_tier"]))
