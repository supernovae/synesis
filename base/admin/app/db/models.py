...
class ModelPublicOffering(Base):
    ...
    connection_mode: Mapped[str] = mapped_column(String(16), nullable=False, default="role_clone")
    route_via_role: Mapped[str | None] = mapped_column(String(64), nullable=True)
    standalone_provider: Mapped[str | None] = mapped_column(String(32), nullable=True)
...
class YarnSession(Base):
    ...
    total_actual_cost_usd: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
...
class YarnUsageLog(Base):
    ...
    tokens_uncached_input: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    ...
    estimated_no_cache_cost_usd: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
