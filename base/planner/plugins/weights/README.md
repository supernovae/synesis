...
**Routing logic:** Easy <5 | Medium 5–15 | Hard >15. Risk ≥15 vetoes to hard. Domain keywords only influence RAG retrieval, never complexity. Routing thresholds (plan_required_above, critic_required_above) live in `routing_thresholds` section of `intent_weights.yaml`.
