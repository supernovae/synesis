...
async def supervisor_node(state: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        out: dict[str, Any] = {
            ...
            "rag_heading_paths": [getattr(r, "heading_path", "") for r in rag_results],
            "rag_document_names": [getattr(r, "document_name", "") for r in rag_results],
            "rag_chunk_summaries": [getattr(r, "chunk_summary", "") for r in rag_results],
